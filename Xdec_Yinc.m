function MatrixXYLs = Xdec_Yinc(x1,y1,x2,y2,xscale,yscale)
            ...
            if (LineSlope ~= -1)
                PixelIntersect = cat(1,ceil(transpose(cat(1,Xcross+1,Ymatrix))),ceil(transpose(cat(1,Xmatrix,Ycross))),ceil([x2,y2]));
